            ...
            <div className="animate-fade-in-up">
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-6">
                <div className="space-y-1.5">
                  ...
                  <input 
                    type="email" 
                    className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all text-gray-900 bg-white shadow-sm hover:border-gray-300 text-base"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all text-gray-900 bg-white shadow-sm hover:border-gray-300 text-base pr-12"
                      placeholder="••••••••"
                      value={password}
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <Link to="/forgot-password" className="text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all">Forgot Password?</Link>
                </div>
