(async () => {
  ...
  // This simulates the old draft fallback!
  addFile('passportDocument', 'Screenshot 2026-05-19 121016.png', 'image/jpeg', 'dummy');
  addFile('photoDocument', 'photo_selfie.jpg', 'image/jpeg', 'dummy');
